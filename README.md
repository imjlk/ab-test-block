...
-   `bun run visual:e2e:ci` checks the most stable front-end subset (`front-a.png`) with a small pixel-diff tolerance and is the only visual parity assertion currently promoted into CI.
